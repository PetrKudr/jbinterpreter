 ...
 * @author petrk
 */
/*package*/ class ASTInterpreterError implements InterpreterError {
    ...
    public ASTInterpreterError(String message, int offendingStartOffset, int offendingStartLine, int offendingStartColumn, int offendingLength) {
